...
/* harmony default export */ __webpack_exports__["default"] = (globalContext$1);
...
exports.rawStringToBuffer = exports.parseHeader = exports.parse = undefined;
...
var PARSE_RESULT_REGEX = /^.*name="([^"]*)"$/;

var rawStringToBuffer = _flowRuntime2.default.annotate(function (str) {
  var _strType = _flowRuntime2.default.string();

  var _returnType = _flowRuntime2.default.return(_flowRuntime2.default.ref(ArrayBuffer));
  ...
  return _returnType.assert(new Uint8Array(arr).buffer);
...
var parseHeader = _flowRuntime2.default.annotate(function (header) {
  var _headerType = _flowRuntime2.default.string();

  var _returnType2 = _flowRuntime2.default.return(_flowRuntime2.default.ref(Object));

  _flowRuntime2.default.param('header', _headerType).assert(header);

  var headerFields = _flowRuntime2.default.ref(Object).assert({});
  var matchResult = _flowRuntime2.default.array(_flowRuntime2.default.string()).assert(header.match(PARSE_RESULT_REGEX));

  if (matchResult) {
    headerFields.name = matchResult[1];
  }
  return _returnType2.assert(headerFields);
}, _flowRuntime2.default.function(_flowRuntime2.default.param('header', _flowRuntime2.default.string()), _flowRuntime2.default.return(_flowRuntime2.default.ref(Object))));
...
var parse = _flowRuntime2.default.annotate(function (body, contentType) {
  ...
  var _returnType3 = _flowRuntime2.default.return(_flowRuntime2.default.ref(Object));
  ...
  for (var i = 1; i < parts.length - 1; i++) {
    ...
    for (var j = 1; j < headers.length; j++) {
      var headerFields = parseHeader(headers[j]);
  ...
  return _returnType3.assert(partsByName);
}, _flowRuntime2.default.function(_flowRuntime2.default.param('body', _flowRuntime2.default.string()), _flowRuntime2.default.param('contentType', _flowRuntime2.default.string()), _flowRuntime2.default.return(_flowRuntime2.default.ref(Object))));
console.log(_os2.default.endianness());
console.log('Enjoy! 🍻');
